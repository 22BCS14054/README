...
contract MyToken{
    string public tokenName = "HARKARAN";
    string public tokenAbbrv ="HKN";
...
To compile the code, click on the "Solidity Compiler" tab in the left side . Make sure the "Compiler" option is set to "0.8.18" , and then click on the ("Compile "the name of the file" ") for ex. comple first.sol button.
...
Contributors names and email id

Harkaran singh

email : balakaran32@gmail.com
